...
% COMTEMP \todo{colocar referencia para trabalhos relevantes do tipo, para a footnote.}\footnote{with some exceptions like the cases where the controller is designed directly from the frequency response obtained experimentally.}.
...
% COMTEMP \todo{Falar um pouco, ou pelo menos citar o \textit{Noniterative data-driven model reference control}} 
