...
% {{{ DEFINICAO DE CORES
\newcommand{\blacksolidlinethin}{\raisebox{2pt}{\tikz{\draw[black,solid,line width=0.5pt](0,0) -- (8mm,0);}}}
...
\newcommand{\bluedashdotedline}{\raisebox{2pt}{\tikz{\draw[blue,dashdotted,line width=1pt](0,0) -- (8mm,0);}}}
...
\newcommand{\reddottedline}{\raisebox{2pt}{\tikz{\draw[red,dotted,line width=1pt](0,0) -- (8mm,0);}}}
...
%   Inicializa variáveis e conjunto de regrassores $\mathscr{R}=\{\phi_{1},\dots,\phi_{m}\}$ \\
%   % \While{$iter < iter_{\max}$}
%    % {
%   Inicializa RIPs ($\bm{\mu}$) \\
%      De 1 até n. modelos sorteados
%       {
%          Para cada regressor candidato\\
%          {
%            $\rho_j \gets \text{Be}(\mu_j)$ \\
%             \If{$\rho_j = 1$}
%             {
%             Regressor é incluido\\
%             }
%          }
%          $\hat{\bm{\theta}}$ é estimado \\
%          $\tilde{\bm{\psi}}(k)) \gets $ Remove regressores redundantes; \\
